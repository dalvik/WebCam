...
public class ImageGridFragment extends Fragment implements AdapterView.OnItemClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
       ...
       // mImageFetcher.addImageCache(getActivity().getApplicationContext(), cacheParams);
    }
    ...
    private class ImageAdapter extends BaseAdapter {
        ...
        public int getCount() {
            ...
            return 0;//Images.imageThumbUrls.length + mNumColumns;
        }

        @Override
        public Object getItem(int position) {
            return 0;//position < mNumColumns ? null : Images.imageThumbUrls[position - mNumColumns];
        }
