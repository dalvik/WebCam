...
ENCODER_SRCS=amrcoder.c 
DECODER_SRCS=amrdecoder.c
...
encoder: $(ENCODER_OBJS) $(SPCLIB) $(FIPOPLIB)
	ar cr  libencoder.a  $(ENCODER_OBJS) $(SPCLIB) $(FIPOPLIB) $(LDFLAGS)
	ranlib libencoder.a

decoder: $(DECODER_OBJS) $(SPCLIB) $(FIPOPLIB)
	ar cr  libdecoder.a  $(DECODER_OBJS) $(SPCLIB) $(FIPOPLIB) $(LDFLAGS)
	ranlib libdecoder.a
